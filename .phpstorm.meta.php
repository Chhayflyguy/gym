...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/khongming/Desktop/myself/gym-bro-tracker/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/khongming/Desktop/myself/gym-bro-tracker/public/storage','logging.default','logging.deprecations.channel',
...
'profile.destroy','workout-logs.store','schedule.index','schedule.store','leaderboard.index',
'schedules.index','schedules.create','schedules.store','schedules.show','schedules.edit',
'schedules.update','schedules.destroy','register','login','password.request','password.email','password.reset','password.store',
...
'layouts.app','layouts.guest','layouts.navigation','leaderboard.index','profile.edit',
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','schedule.create','schedule.edit',
'schedule.index','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.copy-button',
